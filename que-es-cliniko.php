...
<section class="seccion-que-es py-5" style="background-color: #e7e597ff;">
    <div class="contenedor">
        ...
        <p class="descripcion-secundaria mt-3 text-center" style="color: #111111;">
            Clíniko es una aplicación web diseñada para conectar pacientes y médicos a distancia. 
        ...
        <p class="descripcion-secundaria mt-3 text-center" style="color: #111111;">
            También tendrás notificaciones automáticas por correo electrónico para mantener 
